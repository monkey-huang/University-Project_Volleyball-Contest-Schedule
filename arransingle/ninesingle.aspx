<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ninesingle.aspx.cs" Inherits="專題.arransingle.ninesingle" %>
        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <h4> <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="登出" Visible="False" Width=70/></h4>
                    </li>
                    <li>
         ...
         <asp:Label ID="Label21" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label22" runat="server" Text=""></asp:Label>
                ...
                <asp:TextBox ID="TextBox4" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     ...
                     <td class="auto-style6"><asp:TextBox ID="TextBox5" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style7"><asp:TextBox ID="TextBox6" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
