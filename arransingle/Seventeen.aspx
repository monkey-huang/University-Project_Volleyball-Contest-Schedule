<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Seventeen.aspx.cs" Inherits="專題.arransingle.Seventeen" %>
...
<body>
    ...
    <div class="row">
             ...
             <asp:Label ID="Label108" runat="server" Text="" style="font-size: x-large; color: #FF0000"></asp:Label>
             ...
             <table class="eight" border="0">
                                <tr>
                     <td colspan="8" class="auto-style14">
...
<br />
                ...
                <asp:Image ID="Image21" runat="server" ImageUrl="~/img/大普通.jpg" />
                 ...
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label76" runat="server" Text=""></asp:Label>
                         <br />
             <asp:TextBox ID="TextBox35" runat="server" Height="27px" Width="23px"></asp:TextBox> </td>
         ...
         <asp:Label ID="Label78" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label79" runat="server" Text=""></asp:Label>
                ...
                <asp:Image ID="Image23" runat="server"  ImageUrl="~/img/普通LR.jpg"/>
                     </td>
                     <td colspan="2">
                ...
                <asp:Label ID="Label87" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     <td class="auto-style2"> <asp:TextBox ID="TextBox39" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style3">
                <asp:TextBox ID="TextBox40" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style4">
             ...
             <table class="four" border="0">
                     ...
                     <td colspan="5" class="auto-style10">
                                             ...
                                             <br />
                                             <asp:Image ID="Image28" runat="server" ImageUrl="~/img/大大普通.jpg" />
                                    </td>
                 </tr>
                                <tr>
                     <td colspan="4" class="auto-style10">
                ...
                <asp:TextBox ID="TextBox50" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     ...
                     <td colspan="4" class="auto-style10">
                                    ...
                                    <td>
                                        <asp:Image ID="Image27" runat="server" ImageUrl="~/img/大大普通直線.jpg" />
                                    </td>
                 </tr>
               <tr>
