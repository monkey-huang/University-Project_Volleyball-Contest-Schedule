...
{
    public partial class twenty_foursingle : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                if (Session["New"] != null)
                {
                    if (Session["New"].ToString() == "zxcv45628789@gmail.com")
                    {
                        ...
                        {
                            s[23] = Session["Seed team"].ToString();
                    ...
                    Label108.Text = Session["Registration name"] + "「" + Session["Entries"] + "」";   ////設置大標題是甚麼
                }
                else
                {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text != "" && TextBox2.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User.Parameters.AddWithValue("@賽制", "24人單淘汰");
            ...
            if (TextBox3.Text != "" && TextBox4.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_2.Parameters.AddWithValue("@賽制", "24人單淘汰");
            ...
            if (TextBox5.Text != "" && TextBox6.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_3.Parameters.AddWithValue("@賽制", "24人單淘汰");
            ...
            if (TextBox7.Text != "" && TextBox8.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_4.Parameters.AddWithValue("@賽制", "24人單淘汰");
            ...
            if (TextBox9.Text != "" && TextBox10.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_5.Parameters.AddWithValue("@賽制", "24人單淘汰");
                    if (arr2[0] == 1)
                    {
            ...
            if (TextBox11.Text != "" && TextBox12.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_6.Parameters.AddWithValue("@賽制", "24人單淘汰");
                    if (arr2[4] == 1)
                    {
            ...
            if (TextBox13.Text != "" && TextBox14.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_7.Parameters.AddWithValue("@賽制", "24人單淘汰");
                    if (arr2[0] == 2)
                    {
            ...
            else if (c == 1 & d == 1 & f == 0 & TextBox13.Visible == false & TextBox14.Visible == false)
            {
                ...
                Label10.Text = "" + arr2[0] + " " + arr2[1] + " " + arr2[2] + " " + arr2[3] + " " + arr2[4] + " " + arr2[5] + " " + arr2[6] + " " + arr2[7] + " ";
            }
            */
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox49.Text != "" && TextBox50.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        Image28.ImageUrl = "~/img/大大普通LR.jpg";
                        arr4[0] += 1;
                        arr4[1] += 1;
                    ...
                    {
                        Image28.ImageUrl = "~/img/大大普通RR.jpg";
                        arr4[2] += 2;

                    }
                }
            }
           /* if (c == 0 & TextBox31.Visible == false & TextBox32.Visible == false 
                /*& Label11.Text!="" & Label12.Text!="" & Label13.Text!="" & Label14.Text!="" & Label15.Text!="" & Label16.Text!="" & Label17.Text!="" &
                Label18.Text!="")
            {
                c++;
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (arr4[0] > arr4[1] && arr4[0] > arr4[2] & Label68.Visible == true)
            {
            ...
            else if (arr4[1] > arr4[0] && arr4[1] > arr4[2] & Label68.Visible == true)
            {
            ...
            else if (arr4[2] > arr4[1] && arr4[2] > arr4[0] & Label68.Visible == true)
            {
 ...
 /* String[] s = new string[8];
            if (TextBox47.Text != "" & h <= 7)
            {
                s[h] = TextBox47.Text;
                h++;
            }

            Label96.Text = "4564565";
            if (Label96.Text == "")
            {
                Label96.Text = s[0];
            }
