<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eightsingle.aspx.cs" Inherits="專題.arransingle._4single" %>
...
<body>
    ...
    <div class="row">
             ...
             <asp:Label ID="Label36" runat="server" Text="" style="font-size: x-large; color: #FF0000"></asp:Label>
             ...
             <table class="eight" border="0">
                     ...
                     <td colspan="8" class="auto-style10">
                         ...
                         <asp:Image ID="Image7" runat="server" ImageUrl="~/img/大大普通.jpg" />
         ...
         <asp:Label ID="Label21" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox11" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> </td>
                     <td colspan="2" class="auto-style10">
             ...
             <br />
             <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="比賽" Width=100 Visible="False"/>
             <br />
             <br />
