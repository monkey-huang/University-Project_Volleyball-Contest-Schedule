<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fourteen.aspx.cs" Inherits="專題.arrandouble.fourteen" %>
...
<body>
    ...
    <div class="row">
         ...
         <asp:Label ID="Label39" runat="server" Text=""></asp:Label>
             ...
             <asp:Button ID="Button5" runat="server" Text="比賽B" OnClick="Button5_Click" Visible="False" />
                     </td>
                 </tr>
             </table>
             <br />
