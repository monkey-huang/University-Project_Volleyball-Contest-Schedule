...
{
    public partial class Thirty_two : System.Web.UI.Page
    {
            ...
            if (!Page.IsPostBack)
            {
                if (Session["New"] != null)
                {
                    if (Session["New"].ToString() == "zxcv45628789@gmail.com")
                    {
                        ...
                        {
                            s[31] = Session["Seed team"].ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text != "" && TextBox2.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User.Parameters.AddWithValue("@賽制", "32人雙淘汰");
            ...
            if (TextBox3.Text != "" && TextBox4.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_2.Parameters.AddWithValue("@賽制", "32人雙淘汰");
            ...
            if (TextBox5.Text != "" && TextBox6.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_3.Parameters.AddWithValue("@賽制", "32人雙淘汰");
            ...
            if (TextBox7.Text != "" && TextBox8.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_4.Parameters.AddWithValue("@賽制", "32人雙淘汰");
            ...
            if (TextBox9.Text != "" && TextBox10.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_5.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    if (arr2[0] == 1)
                    {
            ...
            if (TextBox11.Text != "" && TextBox12.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_6.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    if (arr2[4] == 1)
                    {
            ...
            if (TextBox13.Text != "" && TextBox14.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_7.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    if (arr2[0] == 2)
                    {
            ...
            if (TextBox26.Text != "" && TextBox27.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        if (arr[6] > arr[7])
                        {
                            Label177.Text = Label47.Text;
                        }
                        else if (arr[6] < arr[7])
                        {
                            Label177.Text = Label48.Text;
                        }
                    ...
                    else if (a < b)
                    {
                        if (arr[4] > arr[5])
                        {
                            Label177.Text = Label45.Text;
                        }
                        else if (arr[4] < arr[5])
                        {
                            Label177.Text = Label46.Text;
                        }
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox125.Text != "" && TextBox126.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_5.Parameters.AddWithValue("@隊伍A", Label242.Text);
                    }
            ...
            if (TextBox127.Text != "" && TextBox128.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_6.Parameters.AddWithValue("@隊伍B", Label248.Text);
                    }
                    User_6.Parameters.AddWithValue("@分數B", b);
            ...
            if (TextBox37.Text != "" && TextBox38.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        if (arr3[6] > arr3[7])
                        {
                            Label200.Text = Label86.Text;
                        }
                        else if (arr3[6] < arr3[7])
                        {
                            Label200.Text = Label87.Text;
                        }
                    ...
                    else if (a < b)
                    {
                        if (arr3[4] > arr3[5])
                        {
                            Label200.Text = Label84.Text;
                        }
                        else if (arr3[4] < arr3[5])
                        {
                            Label200.Text = Label85.Text;
                        }
        ...
        protected void Button12_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox57.Text != "" && TextBox58.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        Label218.Text = Label116.Text;
                        Image32.ImageUrl = "~/img/普通LR.jpg";
                        arr5[0] += 1;
                    }
                    else if (a < b)
                    {
                        Label218.Text = Label115.Text;
            ...
            if (TextBox59.Text != "" && TextBox60.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        Label219.Text = Label118.Text;
                        Image33.ImageUrl = "~/img/普通LR.jpg";
                        arr5[2] += 1;
                    }
                    else if (a < b)
                    {
                        Label219.Text = Label117.Text;
            ...
            if (TextBox61.Text != "" && TextBox62.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        Label220.Text = Label120.Text;
                        Image34.ImageUrl = "~/img/普通LR.jpg";
                        arr5[4] += 1;
                    }
                    else if (a < b)
                    {
                        Label220.Text = Label119.Text;
            ...
            if (TextBox63.Text != "" && TextBox64.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        Label221.Text = Label122.Text;
                        Image35.ImageUrl = "~/img/普通LR.jpg";
                        arr5[6] += 1;
                    }
                    else if (a < b)
                    {
                        Label221.Text = Label121.Text;
            ...
            if (TextBox53.Text != "" && TextBox54.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        if (arr5[2] > arr5[3])
                        {
                            Label222.Text = Label117.Text;
                        }
                        else if (arr5[2] < arr5[3])
                        {
                            Label222.Text = Label118.Text;
                        }
                    ...
                    else if (a < b)
                    {
                        if (arr5[0] > arr5[1])
                        {
                            Label222.Text = Label115.Text;
                        }
                        else if (arr5[0] < arr5[1])
                        {
                            Label222.Text = Label116.Text;
                        }
            ...
            if (TextBox55.Text != "" && TextBox56.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (arr5[6] == 1)
                    {
                        User_6.Parameters.AddWithValue("@隊伍B", Label121.Text);
                    }
                    else if (arr5[7] == 1)
                    {
                        User_6.Parameters.AddWithValue("@隊伍B", Label122.Text);
                    }
                    User_6.Parameters.AddWithValue("@分數B", b);
                    ...
                    if (a > b)
                    {
                        if (arr5[6] > arr5[7])
                        {
                            Label223.Text = Label121.Text;
                        }
                        else if (arr5[6] < arr5[7])
                        {
                            Label223.Text = Label122.Text;
                        }                      
                    ...
                    else if (a < b)
                    {
                        if (arr5[4] > arr5[5])
                        {
                            Label223.Text = Label119.Text;
                        }
                        else if (arr5[4] < arr5[5])
                        {
                            Label223.Text = Label120.Text;
                        }
            ...
            if (TextBox51.Text != "" && TextBox52.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    if (a > b)
                    {
                        if (arr5[4] > arr5[5] & arr5[4] > arr5[6] & arr5[4] > arr5[7])
                        {
                            Label224.Text = Label119.Text;
                        }
                        else if (arr5[5] > arr5[4] & arr5[5] > arr5[6] & arr5[5] > arr5[7])
                        {
                            Label224.Text = Label120.Text;
                        }
                        else if (arr5[6] > arr5[4] & arr5[6] > arr5[5] & arr5[6] > arr5[7])
                        {
                            Label224.Text = Label121.Text;
                        }
                        else if (arr5[7] > arr5[4] & arr5[7] > arr5[5] & arr5[7] > arr5[6])
                        {
                            Label224.Text = Label122.Text;
                        }
                    ...
                    {
                        if (arr5[0] > arr5[1] & arr5[0] > arr5[2] & arr5[0] > arr5[3])
                        {
                            Label224.Text = Label115.Text;
                        }
                        else if (arr5[1] > arr5[0] & arr5[1] > arr5[2] & arr5[1] > arr5[3])
                        {
                            Label224.Text = Label116.Text;
                        }
                        else if (arr5[2] > arr5[0] & arr5[2] > arr5[1] & arr5[2] > arr5[3])
                        {
                            Label224.Text = Label117.Text;
                        }
                        else if (arr5[3] > arr5[0] & arr5[3] > arr5[2] & arr5[3] > arr5[0])
                        {
                            Label224.Text = Label118.Text;
                        }
          ...
          /*  if (c == 0 & TextBox57.Visible == false & TextBox58.Visible == false & TextBox59.Visible == false & TextBox60.Visible
            ...
            */
            ...
            if (Label108.Text == Label248.Text)
            {
                Button12.Visible = false;
        ...
        protected void Button16_Click(object sender, EventArgs e)//B區敗部
        {
            ...
            if (TextBox83.Text != "" && TextBox84.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_5.Parameters.AddWithValue("@隊伍B", Label175.Text);
                    }
            ...
            if (TextBox85.Text != "" && TextBox86.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_6.Parameters.AddWithValue("@隊伍A", Label177.Text);
                    }
...
Button1.Visible = false;
            ...
            if (Label165.Text == Label246.Text)  //最後改
            {
        ...
        protected void Button17_Click(object sender, EventArgs e)//C區敗部
        {
            ...
            if (TextBox97.Text != "" && TextBox98.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_5.Parameters.AddWithValue("@隊伍B", Label198.Text);
                    }
            ...
            if (TextBox99.Text != "" && TextBox100.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    {
                        User_6.Parameters.AddWithValue("@隊伍A", Label200.Text);
                    }
...
Button1.Visible = false;
        ...
        protected void Button18_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox115.Text != "" && TextBox116.Text != "")
            {

                a = Convert.ToInt32(TextBox115.Text);
                b = Convert.ToInt32(TextBox116.Text);
                if (a != b)
                {
                    Label226.Text += a;
                    Label227.Text += b;
                    ...
                    TextBox115.Text = "";
                    TextBox116.Text = "";
                    TextBox111.Visible = true; //開啟上面

                    User.Parameters.AddWithValue("@比賽項目", Session["Registration name"].ToString());
                    User.Parameters.AddWithValue("@參賽組別", Session["Entries"].ToString());
                    User.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    User.Parameters.AddWithValue("@隊伍A", Label218.Text);
                    User.Parameters.AddWithValue("@分數A", a);
                    User.Parameters.AddWithValue("@隊伍B", Label219.Text);
                    User.Parameters.AddWithValue("@分數B", b);
                    User.Parameters.AddWithValue("@區域幾輪", "D區敗部第一輪");
                    User.Parameters.AddWithValue("@日期", str);
                    User.ExecuteNonQuery();

                    if (a > b)
                    {
                        Image60.ImageUrl = "~/img/普通LR.jpg";
                        arr9[0] += 1;
                    }
                    else if (a < b)
                    {
                        Image60.ImageUrl = "~/img/普通RR.jpg";
                        arr9[1] += 1;
                    }
                }
            }
            if (TextBox117.Text != "" && TextBox118.Text != "") 
            {
                a = Convert.ToInt32(TextBox117.Text);
                b = Convert.ToInt32(TextBox118.Text);
                if (a != b)
                {
                    Label228.Text += a;
                    Label229.Text += b;
                    ...
                    User_2.Parameters.AddWithValue("@參賽組別", Session["Entries"].ToString());
                    User_2.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    User_2.Parameters.AddWithValue("@隊伍A", Label220.Text);
                    User_2.Parameters.AddWithValue("@分數A", a);
                    User_2.Parameters.AddWithValue("@隊伍B", Label221.Text);
                    User_2.Parameters.AddWithValue("@分數B", b);
                    User_2.Parameters.AddWithValue("@區域幾輪", "D區敗部第一輪");
                    User_2.Parameters.AddWithValue("@日期", str);
                    User_2.ExecuteNonQuery();

                    if (a > b)
                    {
                        Image61.ImageUrl = "~/img/普通LR.jpg";
                        arr9[2] += 1;
                    }
                    else if (a < b)
                    {
                        Image61.ImageUrl = "~/img/普通RR.jpg";
                        arr9[3] += 1;
                    }
                }
            }
            if (TextBox119.Text != "" && TextBox120.Text != "")
            {
                a = Convert.ToInt32(TextBox119.Text);
                b = Convert.ToInt32(TextBox120.Text);
                if (a != b)
                {
                    Label230.Text += a;
                    Label231.Text += b;
                    ...
                    User_3.Parameters.AddWithValue("@參賽組別", Session["Entries"].ToString());
                    User_3.Parameters.AddWithValue("@賽制", "32人雙淘汰");
                    User_3.Parameters.AddWithValue("@隊伍A", Label222.Text);
                    User_3.Parameters.AddWithValue("@分數A", a);
                    User_3.Parameters.AddWithValue("@隊伍B", Label223.Text);
                    User_3.Parameters.AddWithValue("@分數B", b);
                    User_3.Parameters.AddWithValue("@區域幾輪", "D區敗部第一輪");
                    User_3.Parameters.AddWithValue("@日期", str);
                    User_3.ExecuteNonQuery();
                    ...
                    if (a > b)
                    {
                        Image62.ImageUrl = "~/img/普通LR.jpg";
                        arr9[4] += 1;
                    }
                    else if (a < b)
                    {
                        Image62.ImageUrl = "~/img/普通RR.jpg";
                        arr9[5] += 1;
                    }
                }
            }
            ...
            if (TextBox111.Text != "" && TextBox112.Text != "")///不可能
            {
                a = Convert.ToInt32(TextBox111.Text);
                b = Convert.ToInt32(TextBox112.Text);
                if (a != b)
                {
                    Label214.Text += a;
                    Label215.Text += b;
                    ...
                    if (arr9[0] == 1)
                    {
                        User_5.Parameters.AddWithValue("@隊伍A", Label218.Text);
                    }
                    else if (arr9[1] == 1)
                    {
                        User_5.Parameters.AddWithValue("@隊伍A", Label219.Text);
                    }
                    ...
                    if (arr9[2] == 1)
                    {
                        User_5.Parameters.AddWithValue("@隊伍B", Label220.Text);
                    }
                    else if (arr9[3] == 1)
                    {
                        User_5.Parameters.AddWithValue("@隊伍B", Label221.Text);
                    }

                    User_5.Parameters.AddWithValue("@分數B", b);
                    User_5.Parameters.AddWithValue("@區域幾輪", "D區敗部第二輪");
                    User_5.Parameters.AddWithValue("@日期", str);
                    User_5.ExecuteNonQuery();
                    ...
                    if (a > b)
                    {
                        ...
                        Image58.ImageUrl = "~/img/大普通LR.jpg";
                        arr9[0] += 1;
                        arr9[1] += 1;
                    }
                    else if (a < b)
                    {
                        Image58.ImageUrl = "~/img/大普通RR.jpg";
                        arr9[2] += 1;
                        arr9[3] += 1;
                    }
                }
            }
            if (TextBox113.Text != "" && TextBox114.Text != "")
            {
                a = Convert.ToInt32(TextBox113.Text);
                b = Convert.ToInt32(TextBox114.Text);
                if (a != b)
                {
                    Label216.Text += a;
                    Label217.Text += b;
                    ...
                    if (arr9[4] == 1)
                    {
                        User_6.Parameters.AddWithValue("@隊伍A", Label222.Text);
                    }
                    else if (arr9[5] == 1)
                    {
                        User_6.Parameters.AddWithValue("@隊伍A", Label223.Text);
                    }

                    User_6.Parameters.AddWithValue("@分數A", a);

                    User_6.Parameters.AddWithValue("@隊伍B", Label224.Text);

                    User_6.Parameters.AddWithValue("@分數B", b);
                    User_6.Parameters.AddWithValue("@區域幾輪", "D區敗部第二輪");
                    User_6.Parameters.AddWithValue("@日期", str);
                    User_6.ExecuteNonQuery();

                    if (a > b)
                    {
                        Image59.ImageUrl = "~/img/大普通LR.jpg";
                        arr9[4] += 1;
                        arr9[5] += 1;
                    }
                    else if (a < b)
                    {
                        ...
                        Image59.ImageUrl = "~/img/大普通RR.jpg";
                        arr9[6] += 2;
                        arr9[7] += 1;
                    }
                }
            ...
            {
                a = Convert.ToInt32(TextBox109.Text);
                b = Convert.ToInt32(TextBox110.Text);
                if (a != b)
                {
                    Label212.Text += a;
                    Label213.Text += b;
                    ...
                    if (arr9[0] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍A", Label218.Text);
                    }
                    else if (arr9[1] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍A", Label219.Text);
                    }
                    else if (arr9[2] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍A", Label220.Text);
                    }
                    else if (arr9[3] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍A", Label221.Text);
                    }
                    ...
                    if (arr9[4] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍B", Label222.Text);
                    }
                    else if (arr9[5] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍B", Label223.Text);
                    }
                    else if (arr9[6] == 2)
                    {
                        User_7.Parameters.AddWithValue("@隊伍B", Label224.Text);
                    }


                    User_7.Parameters.AddWithValue("@分數B", b);
                    User_7.Parameters.AddWithValue("@區域幾輪", "D區敗部第三輪");
                    User_7.Parameters.AddWithValue("@日期", str);
                    User_7.ExecuteNonQuery();

                    if (a > b)
                    {
                        Image57.ImageUrl = "~/img/大大普通LR.jpg";
                        arr9[0] += 1;
                        arr9[1] += 1;
                        arr9[2] += 1;
                        arr9[3] += 1;
                    ...
                    else if (a < b)
                    {
                        ...
                        Image57.ImageUrl = "~/img/大大普通RR.jpg";
                        arr9[4] += 1;
                        arr9[5] += 1;
                        arr9[6] += 1;
                        arr9[7] += 1;
...
Button1.Visible = false;
            ...
            if (arr9[0] > arr9[1] && arr9[0] > arr9[2] & arr9[0] > arr9[3] & arr9[0] > arr9[4] & arr9[0] > arr9[5] & arr9[0] > arr9[6] & arr9[0] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label218.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[1] > arr9[0] && arr9[1] > arr9[2] & arr9[1] > arr9[3] & arr9[1] > arr9[4] & arr9[1] > arr9[5] & arr9[1] > arr9[6] & arr9[1] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label219.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[2] > arr9[1] && arr9[2] > arr9[0] & arr9[2] > arr9[3] & arr9[2] > arr9[4] & arr9[2] > arr9[5] & arr9[2] > arr9[6] & arr9[2] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label220.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[3] > arr9[1] && arr9[3] > arr9[2] & arr9[3] > arr9[0] & arr9[3] > arr9[4] & arr9[3] > arr9[5] & arr9[3] > arr9[6] & arr9[3] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label221.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[4] > arr9[1] && arr9[4] > arr9[2] & arr9[4] > arr9[3] & arr9[4] > arr9[0] & arr9[4] > arr9[5] & arr9[4] > arr9[6] & arr9[4] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label222.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[5] > arr9[1] && arr9[5] > arr9[2] & arr9[5] > arr9[3] & arr9[5] > arr9[4] & arr9[5] > arr9[0] & arr9[5] > arr9[6] & arr9[5] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label223.Text;
                Label242.Text = Label211.Text;
            }
            else if (arr9[6] > arr9[1] && arr9[6] > arr9[2] & arr9[6] > arr9[3] & arr9[6] > arr9[4] & arr9[6] > arr9[5] & arr9[6] > arr9[0] & arr9[6] > arr9[7] & Label211.Visible == true)
            {
                Label211.Text = Label224.Text;
                Label242.Text = Label211.Text;
            }
            /*   else if (arr2[7] > arr2[1] && arr2[7] > arr2[2] & arr2[7] > arr2[3] & arr2[7] > arr2[4] & arr2[7] > arr2[5] & arr2[7] > arr2[6] & arr2[7] > arr2[0] & Label67.Visible == true)
               {
            ...
            if (Label242.Text == Label211.Text)  //最後改
            {
