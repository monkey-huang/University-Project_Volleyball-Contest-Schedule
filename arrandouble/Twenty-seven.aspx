<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Twenty-seven.aspx.cs" Inherits="專題.arrandouble.Twenty_seven" %>
...
<br />
             ...
             <asp:TextBox ID="TextBox53" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> </td>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label112" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox54" runat="server" Height="27px" Width="23px"></asp:TextBox> </td>
                     <td colspan="2" class="auto-style10">
         <asp:Label ID="Label113" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label114" runat="server" Text=""></asp:Label>
                ...
                <asp:Image ID="Image33" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
                ...
                <asp:TextBox ID="TextBox58" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     ...
                     <td class="auto-style4">
                <asp:TextBox ID="TextBox59" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style5">
                <asp:TextBox ID="TextBox60" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
         ...
         <asp:Label ID="Label216" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox113" runat="server" Height="27px" Width="23px"></asp:TextBox>
             ...
             <asp:Label ID="Label217" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     ...
                     <td colspan="2">
                         <asp:Image ID="Image62" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox117" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                     ...
                     <td class="auto-style6">
                         <asp:TextBox ID="TextBox119" Height="27px" Width="23px" Visible="False" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style7">
             
                
                   
                <asp:TextBox ID="TextBox120" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
