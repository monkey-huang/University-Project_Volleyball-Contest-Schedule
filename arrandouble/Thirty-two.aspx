<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Thirty-two.aspx.cs" Inherits="專題.arrandouble.Thirty_two" %>
...
<body>
    ...
    <div class="row">
             ...
             <asp:Label ID="Label257" runat="server" Text="" style="font-size: x-large; color: #FF0000"></asp:Label>
             <br />
             ...
             <asp:Label ID="Label167" runat="server" Text=""></asp:Label>
                ...
                <asp:TextBox ID="TextBox83" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     ...
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label169" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox84" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td colspan="2" class="auto-style10">
         <asp:Label ID="Label170" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox85" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
             ...
             <asp:Label ID="Label171" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     ...
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image47" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
                         <asp:Image ID="Image48" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox88" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
                     ...
                     <td class="auto-style4">
             <asp:TextBox ID="TextBox89" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
                     </td>
                     <td class="auto-style5">
                         <asp:TextBox ID="TextBox90" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
                     </td>
                     <td class="auto-style6">
                         <asp:TextBox ID="TextBox91" Height="27px" Width="23px" Visible="true" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style7">
             
                
                   
                <asp:TextBox ID="TextBox92" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
...
<br />
         ...
         <asp:Label ID="Label78" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label79" runat="server" Text=""></asp:Label>
                ...
                <asp:TextBox ID="TextBox38" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                ...
                <asp:Image ID="Image25" runat="server" ImageUrl="~/img/普通.jpg" />
                     ...
                     <td colspan="2">
                <asp:Image ID="Image26" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                 </tr>
                 <tr>
                     <td class="auto-style2">
                ...
                <asp:TextBox ID="TextBox42" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     ...
                     <td class="auto-style8">
                <asp:TextBox ID="TextBox45" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     </td>
                     <td class="auto-style9"><asp:TextBox ID="TextBox46" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                     <td colspan="8"> 
                ...
                <asp:Image ID="Image51" runat="server" ImageUrl="~/img/大普通.jpg" />
                 ...
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label191" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox97" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>

                     </td>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label192" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox98" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td colspan="2" class="auto-style10">
         <asp:Label ID="Label193" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox99" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
             ...
             <asp:Label ID="Label194" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image53" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">

                         <asp:Image ID="Image54" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
                         <asp:Image ID="Image55" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox101" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
                     </td>
                     <td class="auto-style3">

             <asp:TextBox ID="TextBox102" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
             
                     </td>
                     <td class="auto-style4">
             <asp:TextBox ID="TextBox103" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
                     </td>
                     <td class="auto-style5">
                         <asp:TextBox ID="TextBox104" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
                     </td>
                     <td class="auto-style6">
                         <asp:TextBox ID="TextBox105" Height="27px" Width="23px" Visible="true" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style7">
             
                
                   
                <asp:TextBox ID="TextBox106" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
         ...
         <asp:Label ID="Label113" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label114" runat="server" Text=""></asp:Label>
                ...
                <asp:TextBox ID="TextBox56" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                ...
                <asp:Image ID="Image34" runat="server" ImageUrl="~/img/普通.jpg" />
                     ...
                     <td colspan="2">
                <asp:Image ID="Image35" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                 </tr>
                 <tr>
                     <td class="auto-style2">
                ...
                <asp:TextBox ID="TextBox60" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     ...
                     <td class="auto-style8">
                <asp:TextBox ID="TextBox63" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     </td>
                     <td class="auto-style9"><asp:TextBox ID="TextBox64" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                   <td colspan="8">
             ...
             <table class="eight" border="0">
                     ...
                     <td colspan="8" class="auto-style10">
                                             ...
                                             <asp:Image ID="Image57" runat="server" ImageUrl="~/img/大大普通.jpg" /></td>
                 </tr>
               <tr>
                     <td colspan="4" class="auto-style10">
                   
  
             <asp:Label ID="Label212" runat="server" Text=""></asp:Label>
                   
  
                         <br />
                   
  
                <asp:TextBox ID="TextBox109" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
             ...
             <asp:Label ID="Label213" runat="server" Text=""></asp:Label>
                         ...
                         <asp:TextBox ID="TextBox110" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                ...
                <asp:Image ID="Image58" runat="server" ImageUrl="~/img/大普通.jpg" />
                     </td>
                     <td colspan="4" class="auto-style10"><asp:Image ID="Image59" runat="server" ImageUrl="~/img/大普通.jpg" />
                    </td>
                 </tr>
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label214" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox111" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>

                     </td>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label215" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox112" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td colspan="2" class="auto-style10">
         <asp:Label ID="Label216" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox113" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>

                     </td>
                     <td colspan="2" class="auto-style10">
             <asp:Label ID="Label217" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox114" runat="server" Height="27px" Width="23px"></asp:TextBox>
                 ...
                 <tr>
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image60" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">

                         <asp:Image ID="Image61" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
                         <asp:Image ID="Image62" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2">
                         <asp:Image ID="Image63" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                 </tr>
                 <tr>
                     <td class="auto-style2">
                ...
                <asp:Label ID="Label218" runat="server" Text=""></asp:Label>
               
                  
                     </td>
                     <td class="auto-style3"><asp:Label ID="Label219" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style4"><asp:Label ID="Label220" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style5"><asp:Label ID="Label221" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style6">
                  
                <asp:Label ID="Label222" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style7"> <asp:Label ID="Label223" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style8"> <asp:Label ID="Label224" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style9">
                <asp:Label ID="Label225" runat="server" Text=""></asp:Label>
                     </td>
                 </tr>
                 <tr>
                     <td class="auto-style2"><asp:Label ID="Label226" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style3"><asp:Label ID="Label227" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style4"><asp:Label ID="Label228" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style5"><asp:Label ID="Label229" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style6"><asp:Label ID="Label230" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style7"><asp:Label ID="Label231" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style8"><asp:Label ID="Label232" runat="server" Text=""></asp:Label>
                     </td>
                     <td class="auto-style9"><asp:Label ID="Label233" runat="server" Text=""></asp:Label>
             ...
             <asp:TextBox ID="TextBox115" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
                     </td>
                     <td class="auto-style3">

             <asp:TextBox ID="TextBox116" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
             
                     </td>
                     <td class="auto-style4">
             <asp:TextBox ID="TextBox117" runat="server" Height="27px" Width="23px"></asp:TextBox> 
                     </td>
                     <td class="auto-style5">
                         <asp:TextBox ID="TextBox118" runat="server" Height="27px" Width="23px"></asp:TextBox> 
                     </td>
                     <td class="auto-style6">
                         <asp:TextBox ID="TextBox119" Height="27px" Width="23px" Visible="true" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style7">
             
                
                   
                <asp:TextBox ID="TextBox120" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox> 
             
                
                   
                     </td>
                     <td class="auto-style8">
                         <asp:TextBox ID="TextBox121" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style9">
                <asp:TextBox ID="TextBox122" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                 </tr>
                 <tr>
                     <td colspan="8">
                         <asp:Button ID="Button18" runat="server" Text="D區敗部復活" OnClick="Button18_Click" Visible="False" Width=100/>
                 </tr>
             </table>
             <br />
             <br />
             ...
             <asp:Label ID="Label240" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     <td colspan="2" class="auto-style16">
                         ...
                         <asp:Image ID="Image67" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                     <td colspan="2" class="auto-style16">
                     ...
                     <td colspan="2" class="auto-style16">
                         <asp:Image ID="Image70" runat="server" ImageUrl="~/img/普通.jpg" />
                     </td>
                 </tr>
                 <tr>
                ...
                <asp:Label ID="Label241" runat="server" Text="A區冠軍"></asp:Label>
                     ...
                     <td class="auto-style17"><asp:Label ID="Label242" runat="server" Text="D區敗部"></asp:Label>
                     </td>
                     <td class="auto-style17"><asp:Label ID="Label243" runat="server" Text="B區冠軍"></asp:Label>
                     </td>
                     <td class="auto-style18"><asp:Label ID="Label244" runat="server" Text="C區敗部"></asp:Label>
                     </td>
                     <td class="auto-style19">
                  
                <asp:Label ID="Label245" runat="server" Text="C區冠軍"></asp:Label>
                     </td>
                     <td class="auto-style17"> <asp:Label ID="Label246" runat="server" Text="B區敗部"></asp:Label>
                     </td>
                     <td class="auto-style17"> <asp:Label ID="Label247" runat="server" Text="A區敗部"></asp:Label>
                     </td>
                     <td class="auto-style17">
                <asp:Label ID="Label248" runat="server" Text="D區冠軍"></asp:Label>
                     </td>
                 </tr>
                 <tr>
