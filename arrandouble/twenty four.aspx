<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="twenty four.aspx.cs" Inherits="專題.arrandouble.twenty_four" %>
         ...
         <asp:Label ID="Label239" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label240" runat="server" Text=""></asp:Label>
                ...
                <asp:Label ID="Label241" runat="server" Text="A區冠軍"></asp:Label>
                     ...
                     <td class="auto-style4"><asp:Label ID="Label243" runat="server" Text="B區敗部"></asp:Label>
                     </td>
                ...
                <asp:Label ID="Label245" runat="server" Text="C區冠軍"></asp:Label>
                     ...
                     <td class="auto-style7"> <asp:Label ID="Label246" runat="server" Text="A區敗部"></asp:Label>
                     </td>
                     <td class="auto-style8"> <asp:Label ID="Label247" runat="server" Text="B區冠軍"></asp:Label>
                     </td>
                     <td class="auto-style9">
