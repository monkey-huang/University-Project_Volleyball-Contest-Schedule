<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thirty-one.aspx.cs" Inherits="專題.arrandouble.thirty_one" %>
...
<br />
             ...
             <asp:Label ID="Label114" runat="server" Text=""></asp:Label>
                ...
                <asp:Label ID="Label122" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     ...
                     <td class="auto-style8"><asp:Label ID="Label129" runat="server" Visible="False"></asp:Label>
                     </td>
             ...
             <asp:Label ID="Label213" runat="server" Text=""></asp:Label>
                ...
                <asp:TextBox ID="TextBox111" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     ...
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label215" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox112" runat="server" Height="27px" Width="23px"></asp:TextBox>
                     </td>
                     <td colspan="2" class="auto-style10">
         <asp:Label ID="Label216" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label217" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     ...
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image61" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox116" runat="server" Height="27px" Width="23px" Visible="true"></asp:TextBox>
                     ...
                     <td class="auto-style4">
             <asp:TextBox ID="TextBox117" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                     </td>
                     <td class="auto-style5">
                         <asp:TextBox ID="TextBox118" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                     </td>
                     <td class="auto-style6">
         ...
         <asp:Label ID="Label239" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label240" runat="server" Text=""></asp:Label>
                ...
                <asp:Label ID="Label241" runat="server" Text="A區冠軍"></asp:Label>
                     ...
                     <td class="auto-style3"><asp:Label ID="Label242" runat="server" Text="D區敗部"></asp:Label>
                     </td>
