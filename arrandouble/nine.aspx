<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nine.aspx.cs" Inherits="專題.arrandouble.nine" %>
...
<body>
    ...
    <div class="row">
         ...
         <asp:Label ID="Label21" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox11" Height="27px" Width="23px" runat="server"></asp:TextBox>
                     </td>
                     <td colspan="2" class="auto-style10">
             <asp:Label ID="Label22" runat="server" Text=""></asp:Label>
                ...
                <asp:Image ID="Image2" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     ...
                     <td colspan="2">
                <asp:Image ID="Image3" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
                ...
                <asp:TextBox ID="TextBox4" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     ...
                     <td class="auto-style14"><asp:TextBox ID="TextBox5" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style12"><asp:TextBox ID="TextBox6" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style12">
                ...
                <asp:Image ID="Image37" runat="server" ImageUrl="~/img/大普通.jpg" />
                 ...
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label145" runat="server" Text=""></asp:Label>
                         <br />
             <asp:TextBox ID="TextBox69" runat="server" Height="27px" Width="23px"></asp:TextBox> </td>
         ...
         <asp:Label ID="Label147" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label148" runat="server" Text=""></asp:Label>
                ...
                <asp:Image ID="Image39" runat="server"  ImageUrl="~/img/普通LR.jpg"/>
                     </td>
                     <td colspan="2">
                ...
                <asp:Label ID="Label156" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     <td class="auto-style12"> <asp:TextBox ID="TextBox73" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style12">
                <asp:TextBox ID="TextBox74" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style12">
                ...
                <asp:Image ID="Image9" runat="server" ImageUrl="~/img/大普通.jpg" />
                 ...
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label37" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox24" runat="server" Height="27px" Width="23px"></asp:TextBox>
         ...
         <asp:Label ID="Label39" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox26" runat="server" Height="27px" Width="23px"></asp:TextBox>
             ...
             <asp:Label ID="Label40" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image15" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
                     ...
                     <td colspan="2">
                         <asp:Image ID="Image17" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox16" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style3">

             <asp:TextBox ID="TextBox17" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
             ...
             <asp:TextBox ID="TextBox18" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
                     ...
                     <td class="auto-style6">
                         <asp:TextBox ID="TextBox20" Height="27px" Width="23px" Visible="False" runat="server"></asp:TextBox>
                     </td>
                     <td class="auto-style7">
             
                
                   
                <asp:TextBox ID="TextBox21" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox> 
             ...
             <asp:Label ID="Label167" runat="server" Text=""></asp:Label>
                         ...
                         <asp:TextBox ID="TextBox82" runat="server" Height="27px" Width="23px"></asp:TextBox>
                ...
                <asp:Image ID="Image44" runat="server" ImageUrl="~/img/大普通.jpg" />
                     ...
                     <td colspan="4" class="auto-style10"><asp:Image ID="Image45" runat="server" ImageUrl="~/img/大普通LR.jpg" />
                    </td>
                 </tr>
                 <tr>
                     <td colspan="2" class="auto-style10"><asp:Label ID="Label168" runat="server" Text=""></asp:Label>
                         <br />
                <asp:TextBox ID="TextBox83" runat="server" Height="27px" Width="23px"></asp:TextBox>
         ...
         <asp:Label ID="Label170" runat="server" Text=""></asp:Label>
             ...
             <asp:Label ID="Label171" runat="server" Text=""></asp:Label>
                         <br />
                         <asp:TextBox ID="TextBox86" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                 ...
                 <tr>
                     <td colspan="2">
                         ...
                         <asp:Image ID="Image46" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2">
             ...
             <asp:TextBox ID="TextBox87" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
                     </td>
                     <td class="auto-style3">

             <asp:TextBox ID="TextBox88" runat="server" Height="27px" Width="23px" Visible="False"></asp:TextBox>
             ...
             <asp:Label ID="Label240" runat="server" Text=""></asp:Label>
                 ...
                 <tr>
                     ...
                     <td colspan="2" class="auto-style16">
                         ...
                         <asp:Image ID="Image68" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2" class="auto-style16">
                         <asp:Image ID="Image69" runat="server" ImageUrl="~/img/普通LR.jpg" />
                     </td>
                     <td colspan="2" class="auto-style16">
                ...
                <asp:Label ID="Label241" runat="server" Text="A區冠軍"></asp:Label>
                     ...
                     <td class="auto-style5"><asp:Label ID="Label244" runat="server" Text="C區敗部" Visible="False"></asp:Label>
                     </td>
                     <td class="auto-style6">
                  
                         <asp:Label ID="Label246" runat="server" Text="B區敗部"></asp:Label>
                     </td>
                     <td class="auto-style7"> 
                  
                <asp:Label ID="Label245" runat="server" Text="C區冠軍" Visible="False"></asp:Label>
                     </td>
