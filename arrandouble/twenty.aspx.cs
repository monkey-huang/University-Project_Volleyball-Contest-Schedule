        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text != "" && TextBox2.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User.Parameters.AddWithValue("@賽制", "20人雙淘汰");
            ...
            if (TextBox9.Text != "" && TextBox10.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_5.Parameters.AddWithValue("@賽制", "20人雙淘汰");
                    if (arr2[0] == 1)
                    {
            ...
            if (TextBox11.Text != "" && TextBox12.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_6.Parameters.AddWithValue("@賽制", "20人雙淘汰");
                    if (arr2[4] == 1)
                    {
            ...
            if (TextBox13.Text != "" && TextBox14.Text != "")
            {
                ...
                if (a != b)
                {
                    ...
                    User_7.Parameters.AddWithValue("@賽制", "20人雙淘汰");
                    if (arr2[0] == 2)
                    {
