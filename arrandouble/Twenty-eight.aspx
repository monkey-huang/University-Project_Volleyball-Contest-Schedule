<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Twenty-eight.aspx.cs" Inherits="專題.arrandouble.Twenty_eight" %>
        ...
        <div class="container topnav">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <h4> <asp:Button ID="Button4" runat="server" Text="登出" OnClick="Button4_Click" Visible="False" /></h4>
                    </li>
                    <li>
